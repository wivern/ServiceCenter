...
Ext.define('Ext.ux.form.NumericField', 
{
    ...
    getFormattedValue: function(value){
        ...
        else 
        {
            ...
            return Ext.String.format('{0}{1}{2}{3}', (neg ? '-' : ''), (this.currencyAtEnd ? '' : this.currencySymbolValue() + ' ') , value,
                (this.currencyAtEnd ? ' ' + this.currencySymbolValue() : ''));
        }
    },
    currencySymbolValue: function(){
        return (Ext.isEmpty(this.currencySymbol) ? '' : this.currencySymbol);
    },
    /**
    ...
    removeFormat: function(value){
        ...
        {
            value = value.toString().replace(this.currencyAtEnd ? ' ' + this.currencySymbol: this.currencySymbol + ' ', '');
